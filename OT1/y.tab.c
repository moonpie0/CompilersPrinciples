...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ALPHA = 3,                      /* ALPHA  */
  YYSYMBOL_BLANK = 4,                      /* BLANK  */
  YYSYMBOL_5_ = 5,                         /* '|'  */
  YYSYMBOL_6_n_ = 6,                       /* '\n'  */
  YYSYMBOL_7_ = 7,                         /* '*'  */
  YYSYMBOL_8_ = 8,                         /* '('  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ALPHA", "BLANK",
  "'|'", "'\\n'", "'*'", "'('", "')'", "$accept", "lines", "cfg", "and",
  "expr", YY_NULLPTR
};
...
{
       2,    10,    11,     3,     4,     0,     5,    16,     6,     3,
       4,     3,     4,    13,     6,    12,     6,     0,    15,     0,
      14
};

static const yytype_int8 yycheck[] =
{
       0,     6,     6,     3,     4,    -1,     6,    12,     8,     3,
       4,     3,     4,     7,     8,     5,     8,    -1,     9,    -1,
       9
};
